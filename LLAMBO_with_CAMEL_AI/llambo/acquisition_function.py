...
class LLM_ACQ:
    def __init__(self, task_context, n_candidates, n_templates, lower_is_better, 
        ...
        # Define the model, here in this case we use gpt-3.5-turbo
        ...
        self.task_kwargs = {
            'task_prompt': 'helps people find information.',
            'with_task_specify': True,
            'task_specify_agent_kwargs': {'model': model}
        }


        self.user_role_kwargs = {
            'user_role_name': 'an ambitious aspiring TIME TRAVELER recommend a configuration that can achieve the highest possible precision in machine learning',
            'user_agent_kwargs': {'model': model}
        }

        self.assistant_role_kwargs = {
            'assistant_role_name': 'the best-ever experimental mathematician',
